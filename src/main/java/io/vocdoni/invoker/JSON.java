...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.vocdoni.model.AccountsTreasurerGet200Response.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.vocdoni.model.CensusesCensusIDVerifyPost200Response.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.vocdoni.model.ChainOrganizationsCountGet200Response.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.vocdoni.model.CircuitZkCircuitConfig.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.vocdoni.model.ModelsMintTokensTx.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.vocdoni.model.ModelsTxMintTokens.CustomTypeAdapterFactory());
