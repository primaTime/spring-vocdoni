...
import io.vocdoni.model.ModelsProcess;
...
public class ModelsNewProcessTx {
  ...
  **/
  ...
  public ModelsNewProcessTx process(ModelsProcess process) {
  ...
  **/
  @javax.annotation.Nullable
  public ModelsProcess getProcess() {
    return process;
  }


  public void setProcess(ModelsProcess process) {
    this.process = process;
  }


  public ModelsNewProcessTx txtype(ModelsTxType txtype) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsNewProcessTx modelsNewProcessTx = (ModelsNewProcessTx) o;
    return Objects.equals(this.nonce, modelsNewProcessTx.nonce) &&
        Objects.equals(this.process, modelsNewProcessTx.process) &&
        Objects.equals(this.txtype, modelsNewProcessTx.txtype);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nonce, process, txtype);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelsNewProcessTx {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelsNewProcessTx
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsNewProcessTx.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsNewProcessTx is not found in the empty JSON string", ModelsNewProcessTx.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsNewProcessTx.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsNewProcessTx` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `process`
      if (jsonObj.get("process") != null && !jsonObj.get("process").isJsonNull()) {
        ModelsProcess.validateJsonElement(jsonObj.get("process"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsNewProcessTx.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsNewProcessTx' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsNewProcessTx> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsNewProcessTx.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsNewProcessTx>() {
           @Override
           public void write(JsonWriter out, ModelsNewProcessTx value) throws IOException {
 ...
 /**
  * Create an instance of ModelsNewProcessTx given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsNewProcessTx
  * @throws IOException if the JSON string is invalid with respect to ModelsNewProcessTx
  */
  public static ModelsNewProcessTx fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsNewProcessTx.class);
  }

 /**
  * Convert an instance of ModelsNewProcessTx to an JSON string
  *
  * @return JSON string
  */
