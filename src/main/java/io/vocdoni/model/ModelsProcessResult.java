...
import io.vocdoni.model.ModelsQuestionResult;
...
public class ModelsProcessResult {
  public static final String SERIALIZED_NAME_VOTES = "votes";
  @SerializedName(SERIALIZED_NAME_VOTES)
  private List<ModelsQuestionResult> votes;

  public ModelsProcessResult() {
  }

  public ModelsProcessResult votes(List<ModelsQuestionResult> votes) {
    
    this.votes = votes;
    return this;
  }

  public ModelsProcessResult addVotesItem(ModelsQuestionResult votesItem) {
    if (this.votes == null) {
  ...
  **/
  ...
  public List<ModelsQuestionResult> getVotes() {
    return votes;
  }


  public void setVotes(List<ModelsQuestionResult> votes) {
    this.votes = votes;
  }
  ...
  public boolean equals(Object o) {
    ...
    ModelsProcessResult modelsProcessResult = (ModelsProcessResult) o;
    return Objects.equals(this.votes, modelsProcessResult.votes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsProcessResult {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelsProcessResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsProcessResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsProcessResult is not found in the empty JSON string", ModelsProcessResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsProcessResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsProcessResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("votes") != null && !jsonObj.get("votes").isJsonNull()) {
        ...
        if (jsonArrayvotes != null) {
          ...
          for (int i = 0; i < jsonArrayvotes.size(); i++) {
            ModelsQuestionResult.validateJsonElement(jsonArrayvotes.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsProcessResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsProcessResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsProcessResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsProcessResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsProcessResult>() {
           @Override
           public void write(JsonWriter out, ModelsProcessResult value) throws IOException {
 ...
 /**
  * Create an instance of ModelsProcessResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsProcessResult
  * @throws IOException if the JSON string is invalid with respect to ModelsProcessResult
  */
  public static ModelsProcessResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsProcessResult.class);
  }

 /**
  * Convert an instance of ModelsProcessResult to an JSON string
  *
  * @return JSON string
  */
