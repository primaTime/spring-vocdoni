...
public class VotesPost200Response {
  ...
  public VotesPost200Response() {
  }

  public VotesPost200Response voteID(String voteID) {
  ...
  **/
  ...
  public VotesPost200Response txHash(String txHash) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VotesPost200Response votesPost200Response = (VotesPost200Response) o;
    return Objects.equals(this.voteID, votesPost200Response.voteID) &&
        Objects.equals(this.txHash, votesPost200Response.txHash);
  }

  @Override
  public int hashCode() {
    return Objects.hash(voteID, txHash);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VotesPost200Response {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to VotesPost200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VotesPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VotesPost200Response is not found in the empty JSON string", VotesPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VotesPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VotesPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VotesPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VotesPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VotesPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VotesPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<VotesPost200Response>() {
           @Override
           public void write(JsonWriter out, VotesPost200Response value) throws IOException {
 ...
 /**
  * Create an instance of VotesPost200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VotesPost200Response
  * @throws IOException if the JSON string is invalid with respect to VotesPost200Response
  */
  public static VotesPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VotesPost200Response.class);
  }

 /**
  * Convert an instance of VotesPost200Response to an JSON string
  *
  * @return JSON string
  */
