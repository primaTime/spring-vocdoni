...
/**
 * Gets or Sets models.Census_Type
 */
@JsonAdapter(ModelsCensusType.Adapter.class)
public enum ModelsCensusType {
  
  Census_UNKNOWN(0),
  
  Census_ARBO_BLAKE2B(1),
  
  Census_ARBO_POSEIDON(2),
  
  Census_ETHEREUMSTORAGE(3),
  ...
  ModelsCensusType(Integer value) {
    this.value = value;
  }
  ...
  public static ModelsCensusType fromValue(Integer value) {
    for (ModelsCensusType b : ModelsCensusType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModelsCensusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModelsCensusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModelsCensusType read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return ModelsCensusType.fromValue(value);
    }
  }
}
