...
/**
 * Gets or Sets models.CensusOrigin
 */
@JsonAdapter(ModelsCensusOrigin.Adapter.class)
public enum ModelsCensusOrigin {
  
  CensusOrigin_CENSUS_UNKNOWN(0),
  
  CensusOrigin_OFF_CHAIN_TREE(1),
  
  CensusOrigin_OFF_CHAIN_TREE_WEIGHTED(2),
  
  CensusOrigin_OFF_CHAIN_CA(3),
  
  CensusOrigin_ERC20(11),
  
  CensusOrigin_ERC721(12),
  
  CensusOrigin_ERC1155(13),
  
  CensusOrigin_ERC777(14),
  
  CensusOrigin_MINI_ME(15);

  private Integer value;

  ModelsCensusOrigin(Integer value) {
    this.value = value;
  }
  ...
  public static ModelsCensusOrigin fromValue(Integer value) {
    for (ModelsCensusOrigin b : ModelsCensusOrigin.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModelsCensusOrigin> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModelsCensusOrigin enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModelsCensusOrigin read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return ModelsCensusOrigin.fromValue(value);
    }
  }
}
