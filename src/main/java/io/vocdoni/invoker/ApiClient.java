...
import io.vocdoni.invoker.auth.Authentication;
import io.vocdoni.invoker.auth.HttpBasicAuth;
import io.vocdoni.invoker.auth.HttpBearerAuth;
import io.vocdoni.invoker.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api-dev.vocdoni.net/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-dev.vocdoni.net/v2
     ...
     * @return a {@link io.vocdoni.invoker.ApiClient} object
     */
     ...
     * @throws io.vocdoni.invoker.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.vocdoni.invoker.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.vocdoni.invoker.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.vocdoni.invoker.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.vocdoni.invoker.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.vocdoni.invoker.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.vocdoni.invoker.ApiException If fails to update the parameters
     */
     ...
     * @throws io.vocdoni.invoker.ApiException If fail to serialize the request body object into a string
     */
