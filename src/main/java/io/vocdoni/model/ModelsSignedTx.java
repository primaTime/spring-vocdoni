...
public class ModelsSignedTx {
  ...
  public ModelsSignedTx() {
  }

  public ModelsSignedTx signature(List<Integer> signature) {
    
    this.signature = signature;
    return this;
  }

  public ModelsSignedTx addSignatureItem(Integer signatureItem) {
   ...
   /**
   * The signature for the tx bytes. signature is only required in those transactions that actually need signature. I.e zk-Snarks based transactions won&#39;t needed, however the transaction should use this message type in order to preserve consistency on the Vochain
   * @return signature
  **/
  ...
  public ModelsSignedTx tx(List<Integer> tx) {
    
    this.tx = tx;
    return this;
  }

  public ModelsSignedTx addTxItem(Integer txItem) {
    if (this.tx == null) {
  ...
  **/
  ...
  public void setTx(List<Integer> tx) {
    this.tx = tx;
  }
  ...
  public boolean equals(Object o) {
    ...
    ModelsSignedTx modelsSignedTx = (ModelsSignedTx) o;
    return Objects.equals(this.signature, modelsSignedTx.signature) &&
        Objects.equals(this.tx, modelsSignedTx.tx);
  }

  @Override
  public int hashCode() {
    return Objects.hash(signature, tx);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelsSignedTx {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelsSignedTx
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsSignedTx.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsSignedTx is not found in the empty JSON string", ModelsSignedTx.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsSignedTx.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsSignedTx` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsSignedTx.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsSignedTx' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsSignedTx> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsSignedTx.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsSignedTx>() {
           @Override
           public void write(JsonWriter out, ModelsSignedTx value) throws IOException {
 ...
 /**
  * Create an instance of ModelsSignedTx given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsSignedTx
  * @throws IOException if the JSON string is invalid with respect to ModelsSignedTx
  */
  public static ModelsSignedTx fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsSignedTx.class);
  }

 /**
  * Convert an instance of ModelsSignedTx to an JSON string
  *
  * @return JSON string
  */
