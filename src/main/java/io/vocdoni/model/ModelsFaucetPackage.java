...
public class ModelsFaucetPackage {
  ...
  public ModelsFaucetPackage() {
  }

  public ModelsFaucetPackage payload(List<Integer> payload) {
    
    this.payload = payload;
    return this;
  }

  public ModelsFaucetPackage addPayloadItem(Integer payloadItem) {
  ...
  **/
  ...
  public ModelsFaucetPackage signature(List<Integer> signature) {
    
    this.signature = signature;
    return this;
  }

  public ModelsFaucetPackage addSignatureItem(Integer signatureItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsFaucetPackage modelsFaucetPackage = (ModelsFaucetPackage) o;
    return Objects.equals(this.payload, modelsFaucetPackage.payload) &&
        Objects.equals(this.signature, modelsFaucetPackage.signature);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payload, signature);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelsFaucetPackage {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelsFaucetPackage
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsFaucetPackage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsFaucetPackage is not found in the empty JSON string", ModelsFaucetPackage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsFaucetPackage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsFaucetPackage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsFaucetPackage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsFaucetPackage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsFaucetPackage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsFaucetPackage.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsFaucetPackage>() {
           @Override
           public void write(JsonWriter out, ModelsFaucetPackage value) throws IOException {
 ...
 /**
  * Create an instance of ModelsFaucetPackage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsFaucetPackage
  * @throws IOException if the JSON string is invalid with respect to ModelsFaucetPackage
  */
  public static ModelsFaucetPackage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsFaucetPackage.class);
  }

 /**
  * Convert an instance of ModelsFaucetPackage to an JSON string
  *
  * @return JSON string
  */
