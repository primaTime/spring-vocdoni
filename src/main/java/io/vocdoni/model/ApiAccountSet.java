...
public class ApiAccountSet {
  ...
  public ApiAccountSet() {
  }

  public ApiAccountSet metadataURL(String metadataURL) {
  ...
  **/
  ...
  public ApiAccountSet txHash(String txHash) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiAccountSet apiAccountSet = (ApiAccountSet) o;
    return Objects.equals(this.metadataURL, apiAccountSet.metadataURL) &&
        Objects.equals(this.txHash, apiAccountSet.txHash);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataURL, txHash);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiAccountSet {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiAccountSet
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiAccountSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiAccountSet is not found in the empty JSON string", ApiAccountSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiAccountSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiAccountSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiAccountSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiAccountSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiAccountSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiAccountSet.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiAccountSet>() {
           @Override
           public void write(JsonWriter out, ApiAccountSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiAccountSet read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiAccountSet given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiAccountSet
  * @throws IOException if the JSON string is invalid with respect to ApiAccountSet
  */
  public static ApiAccountSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiAccountSet.class);
  }

 /**
  * Convert an instance of ApiAccountSet to an JSON string
  *
  * @return JSON string
  */
