...
public class ApiElectionResultsDetails {
  ...
  public ApiElectionResultsDetails() {
  }

  public ApiElectionResultsDetails aggregation(String aggregation) {
  ...
  **/
  ...
  public ApiElectionResultsDetails display(String display) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiElectionResultsDetails apiElectionResultsDetails = (ApiElectionResultsDetails) o;
    return Objects.equals(this.aggregation, apiElectionResultsDetails.aggregation) &&
        Objects.equals(this.display, apiElectionResultsDetails.display);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregation, display);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiElectionResultsDetails {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiElectionResultsDetails
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiElectionResultsDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiElectionResultsDetails is not found in the empty JSON string", ApiElectionResultsDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiElectionResultsDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiElectionResultsDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiElectionResultsDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiElectionResultsDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiElectionResultsDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiElectionResultsDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiElectionResultsDetails>() {
           @Override
           public void write(JsonWriter out, ApiElectionResultsDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiElectionResultsDetails read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiElectionResultsDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiElectionResultsDetails
  * @throws IOException if the JSON string is invalid with respect to ApiElectionResultsDetails
  */
  public static ApiElectionResultsDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiElectionResultsDetails.class);
  }

 /**
  * Convert an instance of ApiElectionResultsDetails to an JSON string
  *
  * @return JSON string
  */
