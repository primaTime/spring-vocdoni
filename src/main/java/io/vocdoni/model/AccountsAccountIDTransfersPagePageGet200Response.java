...
public class AccountsAccountIDTransfersPagePageGet200Response {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccountsAccountIDTransfersPagePageGet200Response accountsAccountIDTransfersPagePageGet200Response = (AccountsAccountIDTransfersPagePageGet200Response) o;
    return Objects.equals(this.transfers, accountsAccountIDTransfersPagePageGet200Response.transfers);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountsAccountIDTransfersPagePageGet200Response {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccountsAccountIDTransfersPagePageGet200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountsAccountIDTransfersPagePageGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountsAccountIDTransfersPagePageGet200Response is not found in the empty JSON string", AccountsAccountIDTransfersPagePageGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountsAccountIDTransfersPagePageGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountsAccountIDTransfersPagePageGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountsAccountIDTransfersPagePageGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountsAccountIDTransfersPagePageGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountsAccountIDTransfersPagePageGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountsAccountIDTransfersPagePageGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountsAccountIDTransfersPagePageGet200Response>() {
           @Override
           public void write(JsonWriter out, AccountsAccountIDTransfersPagePageGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountsAccountIDTransfersPagePageGet200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccountsAccountIDTransfersPagePageGet200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountsAccountIDTransfersPagePageGet200Response
  * @throws IOException if the JSON string is invalid with respect to AccountsAccountIDTransfersPagePageGet200Response
  */
  public static AccountsAccountIDTransfersPagePageGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountsAccountIDTransfersPagePageGet200Response.class);
  }

 /**
  * Convert an instance of AccountsAccountIDTransfersPagePageGet200Response to an JSON string
  *
  * @return JSON string
  */
