...
public class ApiTransaction {
  ...
  public ApiTransaction code(Integer code) {
  ...
  **/
  ...
  public ApiTransaction hash(String hash) {
  ...
  **/
  ...
  public ApiTransaction response(String response) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiTransaction apiTransaction = (ApiTransaction) o;
    return Objects.equals(this.code, apiTransaction.code) &&
        Objects.equals(this.hash, apiTransaction.hash) &&
        Objects.equals(this.response, apiTransaction.response);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, hash, response);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiTransaction
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiTransaction is not found in the empty JSON string", ApiTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiTransaction>() {
           @Override
           public void write(JsonWriter out, ApiTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiTransaction read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiTransaction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiTransaction
  * @throws IOException if the JSON string is invalid with respect to ApiTransaction
  */
  public static ApiTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiTransaction.class);
  }

 /**
  * Convert an instance of ApiTransaction to an JSON string
  *
  * @return JSON string
  */
