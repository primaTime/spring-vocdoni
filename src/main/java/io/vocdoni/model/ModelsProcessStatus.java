...
/**
 * Gets or Sets models.ProcessStatus
 */
@JsonAdapter(ModelsProcessStatus.Adapter.class)
public enum ModelsProcessStatus {
  
  ProcessStatus_PROCESS_UNKNOWN(0),
  
  ProcessStatus_READY(1),
  
  ProcessStatus_ENDED(2),
  
  ProcessStatus_CANCELED(3),
  
  ProcessStatus_PAUSED(4),
  
  ProcessStatus_RESULTS(5);

  private Integer value;

  ModelsProcessStatus(Integer value) {
    this.value = value;
  }
  ...
  public static ModelsProcessStatus fromValue(Integer value) {
    for (ModelsProcessStatus b : ModelsProcessStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ModelsProcessStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ModelsProcessStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ModelsProcessStatus read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return ModelsProcessStatus.fromValue(value);
    }
  }
}
