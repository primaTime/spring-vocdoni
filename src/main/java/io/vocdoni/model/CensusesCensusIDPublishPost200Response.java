...
public class CensusesCensusIDPublishPost200Response {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CensusesCensusIDPublishPost200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CensusesCensusIDPublishPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CensusesCensusIDPublishPost200Response is not found in the empty JSON string", CensusesCensusIDPublishPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CensusesCensusIDPublishPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CensusesCensusIDPublishPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CensusesCensusIDPublishPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CensusesCensusIDPublishPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CensusesCensusIDPublishPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CensusesCensusIDPublishPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CensusesCensusIDPublishPost200Response>() {
           @Override
           public void write(JsonWriter out, CensusesCensusIDPublishPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CensusesCensusIDPublishPost200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CensusesCensusIDPublishPost200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CensusesCensusIDPublishPost200Response
  * @throws IOException if the JSON string is invalid with respect to CensusesCensusIDPublishPost200Response
  */
  public static CensusesCensusIDPublishPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CensusesCensusIDPublishPost200Response.class);
  }

 /**
  * Convert an instance of CensusesCensusIDPublishPost200Response to an JSON string
  *
  * @return JSON string
  */
