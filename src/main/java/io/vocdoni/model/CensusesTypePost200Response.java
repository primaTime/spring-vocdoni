...
public class CensusesTypePost200Response {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CensusesTypePost200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CensusesTypePost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CensusesTypePost200Response is not found in the empty JSON string", CensusesTypePost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CensusesTypePost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CensusesTypePost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CensusesTypePost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CensusesTypePost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CensusesTypePost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CensusesTypePost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CensusesTypePost200Response>() {
           @Override
           public void write(JsonWriter out, CensusesTypePost200Response value) throws IOException {
 ...
 /**
  * Create an instance of CensusesTypePost200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CensusesTypePost200Response
  * @throws IOException if the JSON string is invalid with respect to CensusesTypePost200Response
  */
  public static CensusesTypePost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CensusesTypePost200Response.class);
  }

 /**
  * Convert an instance of CensusesTypePost200Response to an JSON string
  *
  * @return JSON string
  */
