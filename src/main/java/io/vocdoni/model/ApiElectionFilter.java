...
public class ApiElectionFilter {
  ...
  public static final String SERIALIZED_NAME_WITH_RESULTS = "withResults";
  @SerializedName(SERIALIZED_NAME_WITH_RESULTS)
  private Boolean withResults;

  public ApiElectionFilter() {
  }

  public ApiElectionFilter electionId(String electionId) {
  ...
  **/
  ...
  public ApiElectionFilter organizationId(String organizationId) {
  ...
  **/
  ...
  public ApiElectionFilter status(String status) {
  ...
  **/
  ...
  public ApiElectionFilter withResults(Boolean withResults) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiElectionFilter apiElectionFilter = (ApiElectionFilter) o;
    return Objects.equals(this.electionId, apiElectionFilter.electionId) &&
        Objects.equals(this.organizationId, apiElectionFilter.organizationId) &&
        Objects.equals(this.status, apiElectionFilter.status) &&
        Objects.equals(this.withResults, apiElectionFilter.withResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(electionId, organizationId, status, withResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiElectionFilter {\n");
    sb.append("    electionId: ").append(toIndentedString(electionId)).append("\n");
    sb.append("    organizationId: ").append(toIndentedString(organizationId)).append("\n");
    sb.append("    status: ").append(toIndentedString(status)).append("\n");
    sb.append("    withResults: ").append(toIndentedString(withResults)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiElectionFilter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiElectionFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiElectionFilter is not found in the empty JSON string", ApiElectionFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiElectionFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiElectionFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiElectionFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiElectionFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiElectionFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiElectionFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiElectionFilter>() {
           @Override
           public void write(JsonWriter out, ApiElectionFilter value) throws IOException {
 ...
 /**
  * Create an instance of ApiElectionFilter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiElectionFilter
  * @throws IOException if the JSON string is invalid with respect to ApiElectionFilter
  */
  public static ApiElectionFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiElectionFilter.class);
  }

 /**
  * Convert an instance of ApiElectionFilter to an JSON string
  *
  * @return JSON string
  */
