...
public class ApiProcessMedia {
  ...
  public ApiProcessMedia() {
  }

  public ApiProcessMedia header(String header) {
  ...
  **/
  ...
  public ApiProcessMedia streamUri(String streamUri) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiProcessMedia apiProcessMedia = (ApiProcessMedia) o;
    return Objects.equals(this.header, apiProcessMedia.header) &&
        Objects.equals(this.streamUri, apiProcessMedia.streamUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(header, streamUri);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiProcessMedia {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiProcessMedia
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiProcessMedia.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiProcessMedia is not found in the empty JSON string", ApiProcessMedia.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiProcessMedia.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiProcessMedia` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiProcessMedia.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiProcessMedia' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiProcessMedia> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiProcessMedia.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiProcessMedia>() {
           @Override
           public void write(JsonWriter out, ApiProcessMedia value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiProcessMedia read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiProcessMedia given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiProcessMedia
  * @throws IOException if the JSON string is invalid with respect to ApiProcessMedia
  */
  public static ApiProcessMedia fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiProcessMedia.class);
  }

 /**
  * Convert an instance of ApiProcessMedia to an JSON string
  *
  * @return JSON string
  */
