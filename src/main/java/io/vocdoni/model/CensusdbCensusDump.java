...
import io.vocdoni.model.ModelsCensusType;
...
public class CensusdbCensusDump {
  ...
  public CensusdbCensusDump addDataItem(Integer dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public CensusdbCensusDump maxLevels(Integer maxLevels) {
  ...
  **/
  ...
  public CensusdbCensusDump type(ModelsCensusType type) {
  ...
  **/
  @javax.annotation.Nullable
  public ModelsCensusType getType() {
    return type;
  }


  public void setType(ModelsCensusType type) {
    this.type = type;
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CensusdbCensusDump
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CensusdbCensusDump.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CensusdbCensusDump is not found in the empty JSON string", CensusdbCensusDump.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CensusdbCensusDump.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CensusdbCensusDump` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CensusdbCensusDump.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CensusdbCensusDump' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CensusdbCensusDump> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CensusdbCensusDump.class));

       return (TypeAdapter<T>) new TypeAdapter<CensusdbCensusDump>() {
           @Override
           public void write(JsonWriter out, CensusdbCensusDump value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CensusdbCensusDump read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CensusdbCensusDump given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CensusdbCensusDump
  * @throws IOException if the JSON string is invalid with respect to CensusdbCensusDump
  */
  public static CensusdbCensusDump fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CensusdbCensusDump.class);
  }

 /**
  * Convert an instance of CensusdbCensusDump to an JSON string
  *
  * @return JSON string
  */
