...
public class ModelsProof {
  ...
  public ModelsProof payload(Object payload) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelsProof modelsProof = (ModelsProof) o;
    return Objects.equals(this.payload, modelsProof.payload);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelsProof
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsProof.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsProof is not found in the empty JSON string", ModelsProof.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsProof.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsProof` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsProof.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsProof' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsProof> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsProof.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsProof>() {
           @Override
           public void write(JsonWriter out, ModelsProof value) throws IOException {
 ...
 /**
  * Create an instance of ModelsProof given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsProof
  * @throws IOException if the JSON string is invalid with respect to ModelsProof
  */
  public static ModelsProof fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsProof.class);
  }

 /**
  * Convert an instance of ModelsProof to an JSON string
  *
  * @return JSON string
  */
