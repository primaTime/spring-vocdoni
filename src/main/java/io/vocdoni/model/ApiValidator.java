...
public class ApiValidator {
  ...
  public ApiValidator address(String address) {
  ...
  **/
  ...
  public ApiValidator name(String name) {
  ...
  **/
  ...
  public ApiValidator power(Integer power) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiValidator
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiValidator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiValidator is not found in the empty JSON string", ApiValidator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiValidator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiValidator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiValidator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiValidator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiValidator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiValidator.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiValidator>() {
           @Override
           public void write(JsonWriter out, ApiValidator value) throws IOException {
 ...
 /**
  * Create an instance of ApiValidator given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiValidator
  * @throws IOException if the JSON string is invalid with respect to ApiValidator
  */
  public static ApiValidator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiValidator.class);
  }

 /**
  * Convert an instance of ApiValidator to an JSON string
  *
  * @return JSON string
  */
