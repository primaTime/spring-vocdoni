...
public class ApiOrganizationList {
  ...
  public ApiOrganizationList() {
  }

  public ApiOrganizationList electionCount(Integer electionCount) {
  ...
  **/
  ...
  public ApiOrganizationList organizationID(String organizationID) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiOrganizationList apiOrganizationList = (ApiOrganizationList) o;
    return Objects.equals(this.electionCount, apiOrganizationList.electionCount) &&
        Objects.equals(this.organizationID, apiOrganizationList.organizationID);
  }

  @Override
  public int hashCode() {
    return Objects.hash(electionCount, organizationID);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiOrganizationList {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiOrganizationList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiOrganizationList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiOrganizationList is not found in the empty JSON string", ApiOrganizationList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiOrganizationList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiOrganizationList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiOrganizationList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiOrganizationList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiOrganizationList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiOrganizationList.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiOrganizationList>() {
           @Override
           public void write(JsonWriter out, ApiOrganizationList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiOrganizationList read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiOrganizationList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiOrganizationList
  * @throws IOException if the JSON string is invalid with respect to ApiOrganizationList
  */
  public static ApiOrganizationList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiOrganizationList.class);
  }

 /**
  * Convert an instance of ApiOrganizationList to an JSON string
  *
  * @return JSON string
  */
