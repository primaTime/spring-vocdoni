...
/**
 * Gets or Sets github_com_cometbft_cometbft_types.BlockIDFlag
 */
@JsonAdapter(GithubComCometbftCometbftTypesBlockIDFlag.Adapter.class)
public enum GithubComCometbftCometbftTypesBlockIDFlag {
  ...
  GithubComCometbftCometbftTypesBlockIDFlag(Integer value) {
    this.value = value;
  }
  ...
  public static GithubComCometbftCometbftTypesBlockIDFlag fromValue(Integer value) {
    for (GithubComCometbftCometbftTypesBlockIDFlag b : GithubComCometbftCometbftTypesBlockIDFlag.values()) {
  ...
  public static class Adapter extends TypeAdapter<GithubComCometbftCometbftTypesBlockIDFlag> {
    @Override
    public void write(final JsonWriter jsonWriter, final GithubComCometbftCometbftTypesBlockIDFlag enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GithubComCometbftCometbftTypesBlockIDFlag read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return GithubComCometbftCometbftTypesBlockIDFlag.fromValue(value);
    }
  }
}
