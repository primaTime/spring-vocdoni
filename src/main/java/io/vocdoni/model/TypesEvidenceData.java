...
public class TypesEvidenceData {
  ...
  public TypesEvidenceData() {
  }

  public TypesEvidenceData evidence(List<Object> evidence) {
    
    this.evidence = evidence;
    return this;
  }

  public TypesEvidenceData addEvidenceItem(Object evidenceItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TypesEvidenceData typesEvidenceData = (TypesEvidenceData) o;
    return Objects.equals(this.evidence, typesEvidenceData.evidence);
  }
  ...
  public String toString() {
    ...
    sb.append("class TypesEvidenceData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TypesEvidenceData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypesEvidenceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TypesEvidenceData is not found in the empty JSON string", TypesEvidenceData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TypesEvidenceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TypesEvidenceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypesEvidenceData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypesEvidenceData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypesEvidenceData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypesEvidenceData.class));

       return (TypeAdapter<T>) new TypeAdapter<TypesEvidenceData>() {
           @Override
           public void write(JsonWriter out, TypesEvidenceData value) throws IOException {
 ...
 /**
  * Create an instance of TypesEvidenceData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TypesEvidenceData
  * @throws IOException if the JSON string is invalid with respect to TypesEvidenceData
  */
  public static TypesEvidenceData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypesEvidenceData.class);
  }

 /**
  * Convert an instance of TypesEvidenceData to an JSON string
  *
  * @return JSON string
  */
