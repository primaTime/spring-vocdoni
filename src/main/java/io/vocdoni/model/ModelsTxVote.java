...
public class ModelsTxVote {
  public static final String SERIALIZED_NAME_VOTE = "vote";
  @SerializedName(SERIALIZED_NAME_VOTE)
  private ModelsVoteEnvelope vote;

  public ModelsTxVote() {
  }

  public ModelsTxVote vote(ModelsVoteEnvelope vote) {
  ...
  **/
  ...
  public ModelsVoteEnvelope getVote() {
    return vote;
  }


  public void setVote(ModelsVoteEnvelope vote) {
    this.vote = vote;
  }
  ...
  public boolean equals(Object o) {
    ...
    ModelsTxVote modelsTxVote = (ModelsTxVote) o;
    return Objects.equals(this.vote, modelsTxVote.vote);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelsTxVote
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsTxVote.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsTxVote is not found in the empty JSON string", ModelsTxVote.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsTxVote.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsTxVote` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `vote`
      if (jsonObj.get("vote") != null && !jsonObj.get("vote").isJsonNull()) {
        ModelsVoteEnvelope.validateJsonElement(jsonObj.get("vote"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsTxVote.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsTxVote' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsTxVote> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsTxVote.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsTxVote>() {
           @Override
           public void write(JsonWriter out, ModelsTxVote value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsTxVote read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelsTxVote given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelsTxVote
  * @throws IOException if the JSON string is invalid with respect to ModelsTxVote
  */
  public static ModelsTxVote fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsTxVote.class);
  }

 /**
  * Convert an instance of ModelsTxVote to an JSON string
  *
  * @return JSON string
  */
