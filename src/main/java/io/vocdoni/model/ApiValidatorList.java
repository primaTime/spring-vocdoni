...
import io.vocdoni.model.ApiValidator;
...
public class ApiValidatorList {
  ...
  public ApiValidatorList() {
  }

  public ApiValidatorList validators(List<ApiValidator> validators) {
    
    this.validators = validators;
    return this;
  }

  public ApiValidatorList addValidatorsItem(ApiValidator validatorsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiValidatorList apiValidatorList = (ApiValidatorList) o;
    return Objects.equals(this.validators, apiValidatorList.validators);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiValidatorList {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiValidatorList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiValidatorList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiValidatorList is not found in the empty JSON string", ApiValidatorList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiValidatorList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiValidatorList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("validators") != null && !jsonObj.get("validators").isJsonNull()) {
        ...
        if (jsonArrayvalidators != null) {
          ...
          for (int i = 0; i < jsonArrayvalidators.size(); i++) {
            ApiValidator.validateJsonElement(jsonArrayvalidators.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiValidatorList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiValidatorList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiValidatorList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiValidatorList.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiValidatorList>() {
           @Override
           public void write(JsonWriter out, ApiValidatorList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiValidatorList read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiValidatorList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiValidatorList
  * @throws IOException if the JSON string is invalid with respect to ApiValidatorList
  */
  public static ApiValidatorList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiValidatorList.class);
  }

 /**
  * Convert an instance of ApiValidatorList to an JSON string
  *
  * @return JSON string
  */
