...
public class ApiChoiceMetadata {
  ...
  public ApiChoiceMetadata() {
  }

  public ApiChoiceMetadata title(Map<String, String> title) {
    
    this.title = title;
    return this;
  }

  public ApiChoiceMetadata putTitleItem(String key, String titleItem) {
    if (this.title == null) {
  ...
  **/
  ...
  public ApiChoiceMetadata value(Integer value) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApiChoiceMetadata apiChoiceMetadata = (ApiChoiceMetadata) o;
    return Objects.equals(this.title, apiChoiceMetadata.title) &&
        Objects.equals(this.value, apiChoiceMetadata.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiChoiceMetadata {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiChoiceMetadata
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiChoiceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiChoiceMetadata is not found in the empty JSON string", ApiChoiceMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiChoiceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiChoiceMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiChoiceMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiChoiceMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiChoiceMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiChoiceMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiChoiceMetadata>() {
           @Override
           public void write(JsonWriter out, ApiChoiceMetadata value) throws IOException {
 ...
 /**
  * Create an instance of ApiChoiceMetadata given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiChoiceMetadata
  * @throws IOException if the JSON string is invalid with respect to ApiChoiceMetadata
  */
  public static ApiChoiceMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiChoiceMetadata.class);
  }

 /**
  * Convert an instance of ApiChoiceMetadata to an JSON string
  *
  * @return JSON string
  */
